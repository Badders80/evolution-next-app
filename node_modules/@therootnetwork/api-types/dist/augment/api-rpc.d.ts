...
import type { Bytes, HashMap, Json, Null, Option, Result, Text, U256, U64, Vec, bool, f64, u128, u16, u32, u64 } from "@polkadot/types-codec";
...
import type { EthEventProofResponse, EventProofId } from "@therootnetwork/api-types/interfaces/ethy";
import type { CollectionDetail, CollectionUuid, SerialNumber, TokenId } from "@therootnetwork/api-types/interfaces/nft";
import type { AccountId, AssetId, BlockNumber, H160, H256, H64, Hash, Header, Index, Justification, KeyValue, SignedBlock, StorageData } from "@therootnetwork/api-types/interfaces/runtime";
...
declare module "@polkadot/rpc-core/types/jsonrpc" {
    interface RpcInterface {
        assetsExt: {
             ...
             **/
            freeBalance: AugmentedRpc<(asset: AssetId | AnyNumber | Uint8Array, who: AccountId | string | Uint8Array) => Observable<Text>>;
        };
        author: {
            /**
        ...
        dex: {
             ...
             **/
            getAmountsIn: AugmentedRpc<(amountOut: u128 | AnyNumber | Uint8Array, path: Vec<AssetId> | (AssetId | AnyNumber | Uint8Array)[]) => Observable<Json>>;
            /**
             * Given an array of AssetIds, return amounts out for an amount in
             **/
            getAmountsOut: AugmentedRpc<(amountIn: u128 | AnyNumber | Uint8Array, path: Vec<AssetId> | (AssetId | AnyNumber | Uint8Array)[]) => Observable<Json>>;
            /**
             ...
             **/
            getTradingPairStatus: AugmentedRpc<(assetA: AssetId | AnyNumber | Uint8Array, assetB: AssetId | AnyNumber | Uint8Array) => Observable<Text>>;
            /**
        ...
        nft: {
             ...
             **/
            collectionDetails: AugmentedRpc<(collectionId: u32 | AnyNumber | Uint8Array) => Observable<Result<CollectionDetail, Text>>>;
            /**
        ...
        syloDataPermissions: {
             ...
             **/
            getPermissions: AugmentedRpc<(dataAuthor: AccountId | string | Uint8Array, grantee: AccountId | string | Uint8Array, dataIds: Vec<Text> | (Text | string)[]) => Observable<Result<GetPermissionsResult, Text>>>;
        };
        syncstate: {
            /**
