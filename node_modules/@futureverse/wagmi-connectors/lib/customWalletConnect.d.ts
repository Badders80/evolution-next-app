import { Compute, ExactPartial, Omit } from '@wagmi/core/internal';
import { EthereumProvider } from '@walletconnect/ethereum-provider';
import { Address, ProviderConnectInfo } from 'viem';
...
export declare function customWalletConnect(parameters: WalletConnectParameters): import('@wagmi/core').CreateConnectorFn<import('@walletconnect/ethereum-provider').default, {
    connect(parameters?: {
...
export declare namespace customWalletConnect {
    var type: "walletConnectCustom";
}
export {};
