...
function getAuthenticatorData(options = {}) {
  ...
  const rpIdHash = sha2565(fromString2(rpId));
...
function getSignPayload(options) {
  ...
  const clientDataJSONHash = sha2565(fromString2(clientDataJSON));
...
function verify2(options) {
  ...
  if (fromBytes(toBytes4(challenge_extracted)) !== challenge)
    return false;
  const clientDataJSONHash = sha2565(fromString(clientDataJSON), {
    as: "Bytes"
  });
...
function tower12(opts) {
  ...
  function isValidC(num, ORDER2) {
    return typeof num === "bigint" && _0n3 <= num && num < ORDER2;
  }
...
*/
//# sourceMappingURL=chunk-JU7NJW6Z.js.map
