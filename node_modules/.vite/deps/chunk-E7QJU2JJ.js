...
import {
  secp256k1
} from "./chunk-YNUQFDQ6.js";
import {
  sha256
} from "./chunk-YLGHVNRG.js";
import {
  utf8ToBytes
} from "./chunk-5MKN5QPP.js";
import {
  __esm
...
var SHA256_K, SHA256_W, SHA256, SHA224, K512, SHA512_Kh, SHA512_Kl, SHA512_W_H, SHA512_W_L, SHA512, SHA384, T224_IV, T256_IV, SHA512_224, SHA512_256, sha2562, sha224, sha5122, sha384, sha512_256, sha512_224;
var init_sha2 = __esm({
  "node_modules/@noble/curves/node_modules/@noble/hashes/esm/sha2.js"() {
    init_md();
    init_u64();
    ...
    sha2562 = createHasher(() => new SHA256());
    sha224 = createHasher(() => new SHA224());
    sha5122 = createHasher(() => new SHA512());
...
var init_modular = __esm({
  "node_modules/@noble/curves/esm/abstract/modular.js"() {
    ...
    _9n = BigInt(9);
    _16n = BigInt(16);
    isNegativeLE = (num2, modulo) => (mod2(num2, modulo) & _1n2) === _1n2;
    FIELD_FIELDS = [
      "create",
      "isValid",
      "is0",
...
function ecdsa(Point3, hash, ecdsaOpts = {}) {
  ...
  const hmac_ = ecdsaOpts.hmac || ((key, ...msgs) => hmac2(hash, key, concatBytes2(...msgs)));
  const { Fp, Fn } = Point3;
...
function schnorrGetExtPubKey(priv) {
  let d_ = _normFnElement(Point2.Fn, priv);
...
var secp256k1_CURVE, secp256k1_ENDO, _0n5, _1n5, _2n3, Fpk1, secp256k12, TAGGED_HASH_PREFIXES, pointToBytes, numTo32b, modP, modN, Point2, hasEven, num, schnorr, isoMap, mapSWU, secp256k1_hasher, hashToCurve, encodeToCurve;
var init_secp256k1 = __esm({
  "node_modules/@noble/curves/esm/secp256k1.js"() {
    ...
    secp256k12 = createCurve({ ...secp256k1_CURVE, Fp: Fpk1, lowS: true, endo: secp256k1_ENDO }, sha2562);
...
*/
//# sourceMappingURL=chunk-E7QJU2JJ.js.map
